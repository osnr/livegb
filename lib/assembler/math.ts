...
function spaced<A>(parser: Parser<A>): Parser<A> {
...
function operators(ops: {[name: string]: string}) {
...
function PREFIX(operatorsParser: Parser<any>, nextParser: Parser<any>): Parser<any> {
  var parser: Parser<any> = P.lazy(function() {
...
// operators.
function POSTFIX(operatorsParser: Parser<any>, nextParser: Parser<any>): Parser<any> {
...
function BINARY_RIGHT(operatorsParser: Parser<any>, nextParser: Parser<any>): Parser<any> {
  var parser: Parser<any> = P.lazy(function() {
...
function BINARY_LEFT(operatorsParser: Parser<any>, nextParser: Parser<any>): Parser<any> {
...
export function math<A>(value: Parser<A>): Parser<any> {
  // A basic value is any parenthesized expression or a number.
  var Basic: Parser<any> =
    P.lazy(function() {
      return P.string('(')
        .then(myMath)
        .skip(P.string(')'))
  ...
  const myMath = table.reduce(function(acc, level) {
