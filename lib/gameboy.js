...
function Emitter(s) {
  s.emit = function(name) { console.log(name) }
}
...
function GameBoyCore(canvas, ROMImage, opts) {
  ...
  //Params, etc...
  this.help = canvas;           //Canvas DOM object for drawing out the graphics to.
...
GameBoyCore.prototype.ROMLoad = function (reloading) {
